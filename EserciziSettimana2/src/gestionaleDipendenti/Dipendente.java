...
public class Dipendente {
	...
	public Dipendente(Dipartimento dipartimento, String matricola, double stipendio, double importoOrarioStraordinario,
			Livello livello) {
		this.dipartimento = dipartimento;
		this.matricola = matricola;
	...
	public void stampaDatiDipendente() {
		System.out.println("matricola: " + matricola + " Stipendio: " + stipendio + " Importo orario straordinario: "
	...
	public static double calcolaPaga (Dipendente dip, double oreStraordinario) {
		double stipendioTotale = dip.stipendio + dip.importoOrarioStraordinario * oreStraordinario;
